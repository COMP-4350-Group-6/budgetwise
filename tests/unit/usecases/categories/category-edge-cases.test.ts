...
import { makeCreateCategory, makeUpdateCategory, makeListCategories, makeDeleteCategory, makeSeedDefaultCategories } from '@budget/usecases';
...
describe('Category Edge Cases & Boundary Tests', () => {
  ...
  describe('Edge Cases - Deletion', () => {
    it('should prevent deleting category with active budgets', async () => {
      ...
      const { makeCreateBudget } = await import('@budget/usecases');
