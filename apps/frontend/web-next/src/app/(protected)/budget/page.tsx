...
export default function BudgetPage() {
  ...
  // Memoize loadDashboard to use in useEffect and other handlers
  ...
  }, [budgetService, categoryService, transactionService]);

  // Load dashboard on mount - services are stable from context
  useEffect(() => {
    loadDashboard();
  }, [loadDashboard]);
  ...
  const handleEditBudget = (
    ...
    setFormData({
      ...
      startDate: budget.budget?.startDate
        ? new Date(budget.budget.startDate).toISOString().split("T")[0]
