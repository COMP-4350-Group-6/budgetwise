...
export const openApiSpec = {
  ...
  "info": {
    ...
    "version": "1.0.0",
    "description": "API for the BudgetWise personal finance management application. This API provides endpoints for managing budgets, categories, transactions, and user authentication.",
    "contact": {
        ...
        "parameters": [
          {
            ...
            "name": "active",
            "schema": {
              "description": "Filter active only (true/false)",
              "type": "string"
            },
            "description": "Filter active only (true/false)"
          }
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "amountCents": {
                    "description": "Budget amount in cents (e.g. 50000 = $500)",
                    "example": 50000,
                    "type": "integer",
                    "minimum": 0,
                    "maximum": 100000000
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "amountCents": {
                    "description": "Transaction amount in cents (e.g. 2500 = $25)",
                    "example": 2500,
                    "type": "integer",
                    "minimum": -100000000,
                    "maximum": 100000000
    ...
    "schemas": {
      ...
      "AuthUser": {
        ...
        "properties": {
          ...
          "defaultCurrency": {
            "description": "User default currency",
            "type": "string"
          },
          "createdAt": {
      ...
      "BudgetStatus": {
        ...
        "properties": {
          ...
          "isOverBudget": {
            "description": "Whether spending exceeded budget",
            "example": false,
            "type": "boolean"
          },
          "shouldAlert": {
            "description": "Whether to show alert",
            "example": false,
            "type": "boolean"
          },
          "transactionCount": {
      ...
      "CategorizationResult": {
        ...
        "properties": {
          ...
          "reasoning": {
            "description": "AI reasoning for suggestion",
            "type": "string"
          }
        },
        "required": [
